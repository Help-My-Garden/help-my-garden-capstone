...
allPlantsRouter.route('/plant-duration/:platDuration').get(asyncValidatorController([check("plantDuration", "please provide plant duration").isString().notEmpty().trim().escape()]), getPlantsByDurationController)
